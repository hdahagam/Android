...
/**
 * Created by hdahagam on 9/19/2017.
 */
...
// Movie detail information is your choice .
        ...
        poster_path="hhgggggh";
        moviesList.add(createMovie(id, R.drawable.annabelle,vote_count,vote_avg, title, poster_path, overview, genres)) ;
        //2
        id=346364;
        vote_count=371;
        vote_avg=7.4;
        ...
        moviesList.add(createMovie(id,R.drawable.it,vote_count,vote_avg, title, poster_path, overview, genres)) ;
        //3
        id=339304;
        vote_count=41;
        vote_avg=4.7;
        ...
        moviesList.add(createMovie(id,R.drawable.layover,vote_count,vote_avg, title, poster_path, overview, genres)) ;
        //4
        id=390043;
        vote_count=508;
        vote_avg=6.4;
        ...
        moviesList.add(createMovie(id,R.drawable.hitmansbodygaurd,vote_count,vote_avg, title, poster_path, overview, genres)) ;
        //5
        id=315635;
        vote_count=3014;
        vote_avg=7.3;
        ...
        moviesList.add(createMovie(id,R.drawable.spiderman,vote_count,vote_avg, title, poster_path, overview, genres)) ;
        //6
        id=324852;
        vote_count=1687;
        vote_avg=6.2;
        ...
        moviesList.add(createMovie(id,R.drawable.despicable3,vote_count,vote_avg, title,poster_path, overview, genres)) ;
        //7
        id=353491;
        vote_count=549;
        vote_avg=5.6;
        ...
        moviesList.add(createMovie(id,R.drawable.darktower,vote_count,vote_avg, title, poster_path,overview, genres)) ;
        //8
        id=374720;
        vote_count=2214;
        vote_avg=7.5;
        ...
        moviesList.add(createMovie(id,R.drawable.dunkirk,vote_count,vote_avg, title,poster_path, overview, genres)) ;
        //9
        id=293768;
        vote_count=202;
        vote_avg=5.8;
        ...
        moviesList.add(createMovie(id,R.drawable.kidnap,vote_count,vote_avg, title, poster_path,overview, genres)) ;
        //10
        id=381283;
        vote_count=13;
        vote_avg=5.9;
        ...
        moviesList.add(createMovie(id,R.drawable.mother,vote_count,vote_avg, title,poster_path, overview, genres)) ;
        //11
        id=339692;
        vote_count=188;
        vote_avg=6.9;
        ...
        moviesList.add(createMovie(id,R.drawable.shotcaller,vote_count,vote_avg, title, poster_path,overview, genres)) ;
        //12
        id=430682;
        vote_count=11;
        vote_avg=5.5;
        ...
        moviesList.add(createMovie(id,R.drawable.gunshy,vote_count,vote_avg, title,poster_path, overview, genres)) ;
        //13
        id=281338;
        vote_count=1425;
        vote_avg=6.7;
        ...
        moviesList.add(createMovie(id,R.drawable.warofapes,vote_count,vote_avg, title,poster_path, overview, genres)) ;
        //14
        id=433637;
        vote_count=0;
        vote_avg=0.0;
        ...
        moviesList.add(createMovie(id,R.drawable.whatstillremains,vote_count,vote_avg, title, poster_path, overview, genres)) ;
        //15
        id=395814;
        vote_count=32;
        vote_avg=6.6;
        ...
        moviesList.add(createMovie(id,R.drawable.rememory,vote_count,vote_avg, title, poster_path, overview, genres)) ;
        //16
        id=342473;
        vote_count=352;
        vote_avg=7.1;
        ...
        moviesList.add(createMovie(id,R.drawable.ballerina,vote_count,vote_avg, title, poster_path, overview, genres)) ;
        //17
        id=427900;
        vote_count=7;
        vote_avg=3.4;
        ...
        moviesList.add(createMovie(id,R.drawable.homeagain,vote_count,vote_avg, title, poster_path, overview, genres)) ;
        //18
        id=399170;
        vote_count=83;
        vote_avg=6.6;
        ...
        moviesList.add(createMovie(id,R.drawable.loganlucky,vote_count,vote_avg, title, poster_path, overview, genres)) ;
        //19
        id=408648;
        vote_count=57;
        vote_avg=5.5;
        ...
        moviesList.add(createMovie(id,R.drawable.batman,vote_count,vote_avg, title, poster_path, overview, genres)) ;
        //20
        id=467432;
        vote_count=3;
        vote_avg=6.0;
        ...
        moviesList.add(createMovie(id,R.drawable.thegame,vote_count,vote_avg, title, poster_path, overview, genres)) ;
        //21
        id=211672;
        vote_count=4381;
        vote_avg=6.4;
        ...
        moviesList.add(createMovie(id,R.drawable.minions,vote_count,vote_avg, title, poster_path, overview, genres)) ;
        //22
        id=118340;
        vote_count=9398;
        vote_avg=7.9;
        ...
        moviesList.add(createMovie(id,R.drawable.guardiansofgalaxy,vote_count,vote_avg, title, poster_path, overview, genres)) ;
        //23
        id=321612;
        vote_count=5158;
        vote_avg=6.8;
        ...
        moviesList.add(createMovie(id, R.drawable.beautyandthebeast,vote_count,vote_avg, title, poster_path, overview, genres)) ;
        //24
        id=157336;
        vote_count=10592;
        vote_avg=8.1;
        ...
        moviesList.add(createMovie(id,R.drawable.interstellar,vote_count,vote_avg, title, poster_path, overview, genres)) ;
        //25
        id=415842;
        vote_count=5;
        vote_avg=4.2;
        ...
        moviesList.add(createMovie(id, R.drawable.americanassassin,vote_count,vote_avg, title, poster_path, overview, genres)) ;

    }

    private HashMap createMovie(Integer id, int image,Integer vCount, Double vAvg, String title,String poster, String overview, List < Integer > genres ) {
